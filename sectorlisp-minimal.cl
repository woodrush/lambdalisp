...
(defun-lazy alphabet-prefix (x) (cons t (cons nil (cons t x))))
(def-lazy "A" (alphabet-prefix "A-tail"))
(def-lazy "B" (alphabet-prefix "B-tail"))
(def-lazy "C" (alphabet-prefix "C-tail"))
(def-lazy "D" (alphabet-prefix "D-tail"))
(def-lazy "E" (alphabet-prefix "E-tail"))
(def-lazy "F" (alphabet-prefix "F-tail"))
(def-lazy "G" (alphabet-prefix "G-tail"))
(def-lazy "H" (alphabet-prefix "H-tail"))
(def-lazy "I" (alphabet-prefix "I-tail"))
(def-lazy "J" (alphabet-prefix "J-tail"))
(def-lazy "K" (alphabet-prefix "K-tail"))
(def-lazy "L" (alphabet-prefix "L-tail"))
(def-lazy "M" (alphabet-prefix "M-tail"))
(def-lazy "N" (alphabet-prefix "N-tail"))
(def-lazy "O" (alphabet-prefix "O-tail"))
(def-lazy "P" (alphabet-prefix "P-tail"))
(def-lazy "Q" (alphabet-prefix "Q-tail"))
(def-lazy "R" (alphabet-prefix "R-tail"))
(def-lazy "S" (alphabet-prefix "S-tail"))
(def-lazy "T" (alphabet-prefix "T-tail"))
(def-lazy "U" (alphabet-prefix "U-tail"))
(def-lazy "V" (alphabet-prefix "V-tail"))
(def-lazy "W" (alphabet-prefix "W-tail"))
(def-lazy "X" (alphabet-prefix "X-tail"))
(def-lazy "Y" (alphabet-prefix "Y-tail"))
(def-lazy "Z" (alphabet-prefix "Z-tail"))

(def-lazy "A-tail" (cons t (cons t (cons t (cons t (cons nil nil))))))
(def-lazy "B-tail" (cons t (cons t (cons t (cons nil (cons t nil))))))
(def-lazy "C-tail" (cons t (cons t (cons t (cons nil (cons nil nil))))))
(def-lazy "D-tail" (cons t (cons t (cons nil (cons t (cons t nil))))))
(def-lazy "E-tail" (cons t (cons t (cons nil (cons t (cons nil nil))))))
(def-lazy "F-tail" (cons t (cons t (cons nil (cons nil (cons t nil))))))
(def-lazy "G-tail" (cons t (cons t (cons nil (cons nil (cons nil nil))))))
(def-lazy "H-tail" (cons t (cons nil (cons t (cons t (cons t nil))))))
(def-lazy "I-tail" (cons t (cons nil (cons t (cons t (cons nil nil))))))
(def-lazy "J-tail" (cons t (cons nil (cons t (cons nil (cons t nil))))))
(def-lazy "K-tail" (cons t (cons nil (cons t (cons nil (cons nil nil))))))
(def-lazy "L-tail" (cons t (cons nil (cons nil (cons t (cons t nil))))))
(def-lazy "M-tail" (cons t (cons nil (cons nil (cons t (cons nil nil))))))
(def-lazy "N-tail" (cons t (cons nil (cons nil (cons nil (cons t nil))))))
(def-lazy "O-tail" (cons t (cons nil (cons nil (cons nil (cons nil nil))))))
(def-lazy "P-tail" (cons nil (cons t (cons t (cons t (cons t nil))))))
(def-lazy "Q-tail" (cons nil (cons t (cons t (cons t (cons nil nil))))))
(def-lazy "R-tail" (cons nil (cons t (cons t (cons nil (cons t nil))))))
(def-lazy "S-tail" (cons nil (cons t (cons t (cons nil (cons nil nil))))))
(def-lazy "T-tail" (cons nil (cons t (cons nil (cons t (cons t nil))))))
(def-lazy "U-tail" (cons nil (cons t (cons nil (cons t (cons nil nil))))))
(def-lazy "V-tail" (cons nil (cons t (cons nil (cons nil (cons t nil))))))
(def-lazy "W-tail" (cons nil (cons t (cons nil (cons nil (cons nil nil))))))
(def-lazy "X-tail" (cons nil (cons nil (cons t (cons t (cons t nil))))))
(def-lazy "Y-tail" (cons nil (cons nil (cons t (cons t (cons nil nil))))))
(def-lazy "Z-tail" (cons nil (cons nil (cons t (cons nil (cons t nil))))))
