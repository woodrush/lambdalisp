...
(defun-lazy alphabet-prefix-t (x) (p-t-nil (cons t (cons t x))))
...
(def-lazy "A-tail" (p-t-t (cons t (cons nil nil))))
(def-lazy "B-tail" (p-t-t (cons nil (cons t nil))))
(def-lazy "C-tail" (p-t-t (cons nil (cons nil nil))))
(def-lazy "D-tail" (p-t-nil (cons t (cons t nil))))
(def-lazy "E-tail" (p-t-nil (cons t (cons nil nil))))
(def-lazy "F-tail" (p-t-nil (cons nil (cons t nil))))
(def-lazy "G-tail" (p-t-nil (cons nil (cons nil nil))))
(def-lazy "H-tail" (p-nil-t (cons t (cons t nil))))
(def-lazy "I-tail" (p-nil-t (cons t (cons nil nil))))
(def-lazy "J-tail" (p-nil-t (cons nil (cons t nil))))
(def-lazy "K-tail" (p-nil-t (cons nil (cons nil nil))))
(def-lazy "L-tail" (p-nil-nil (cons t (cons t nil))))
(def-lazy "M-tail" (p-nil-nil (cons t (cons nil nil))))
(def-lazy "N-tail" (p-nil-nil (cons nil (cons t nil))))
(def-lazy "O-tail" (p-nil-nil (cons nil (cons nil nil))))
(def-lazy "P-tail" (p-t-t (cons t (cons t nil))))
(def-lazy "Q-tail" (p-t-t (cons t (cons nil nil))))
(def-lazy "R-tail" (p-t-t (cons nil (cons t nil))))
(def-lazy "S-tail" (p-t-t (cons nil (cons nil nil))))
(def-lazy "T-tail" (p-t-nil (cons t (cons t nil))))
(def-lazy "U-tail" (p-t-nil (cons t (cons nil nil))))
